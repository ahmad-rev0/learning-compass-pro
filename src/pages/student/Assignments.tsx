...
import { FileText, Code, Upload, BookOpen, List, Clock, CheckCircle, Send } from "lucide-react";
      ...
      {isLoading ? (
        ...
        <Card className="border-2 border-dashed border-border">
          <CardContent className="py-8 text-center text-muted-foreground">
            No assignments yet. You'll see them here once your teacher creates them.
          </CardContent>
        </Card>
      ) : (
